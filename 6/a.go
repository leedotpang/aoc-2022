...
func find_solution(content string) int {
	// loop over file until 4 unique strings are found -- get the index
...
func main() {
	...
	// content_str := "nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg"

	fmt.Println("First packet marker position: ", find_solution(content_str))
}
